    ...
    return SafeArea(
      ...
      body: ValueListenableBuilder(
          ...
          builder: (BuildContext context, List<TransactionModel> newList,
              Widget? child) {
                var allIncome = newList.where((element) => element.finanace =='expense').toList();
                return overViewGraphNotifier.value.isEmpty?const SingleChildScrollView(child:Center(
                  child: Column(
                ...
                :SfCircularChart(
                  series: <CircularSeries>[
                    PieSeries<TransactionModel,String>(
                      ...
                      xValueMapper: (TransactionModel expenseData, _)=>expenseData.category.categoryName,
                      yValueMapper: (TransactionModel expenseData, _)=>num.parse(expenseData.amount),
