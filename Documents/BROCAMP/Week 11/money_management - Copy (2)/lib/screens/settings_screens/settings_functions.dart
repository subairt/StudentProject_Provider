...
class SettingFunctions extends ChangeNotifier {
  ...
  editLimit(BuildContext context) async {
    ...
    var limitvariabel1 = sharedPref.getString('limit') ?? '';
    limitchangecontroller = TextEditingController(text: limitvariabel1);
    showdialog(context);
  }
            ...
            actions: [
              TextButton(
                  onPressed: (() async {
                    ...
                    TransactionDB().transactionListNotifer.value.clear();
                    TransactionDB().transactionListNotifer.notifyListeners();
